...
class _CallScreenState extends State<CallScreen> {
  ...
  void initState() {
    ...
    _socket = _iCallViewModel.socket;
  ...
  _watchCommonSocketEvents() {
    _socket!.on("left-call", (data) {
      _printSpace();
      print("${_iCallViewModel.callInfo.receiverId} Left the call, quit now");
      _printSpace();
  ...
  _setupConnection() async {
    ...
    if (_iCallViewModel.callInfo.isCaller as bool) {
      ...
      _socket!.on("call-accepted", (data) async {
        ...
        _socket!.emit("offer", {
          'offer': offer.toMap(),
          'to': _iCallViewModel.callInfo.receiverId
        });
      });
      ...
      _socket!.emit("start-call", {
        "to": _iCallViewModel.callInfo.receiverId,
        'callerName': _iCallViewModel.callInfo.callerName,
        'callerId': _iCallViewModel.callInfo.callerId,
        'callerAvatar': _iCallViewModel.callInfo.callerAvatar,
      });
    ...
    if (!(_iCallViewModel.callInfo.isCaller as bool)) {
      ...
      // accept call
      _socket!.emit("accept-call", {"to": _iCallViewModel.callInfo.callerId});
            ...
            Positioned.fill(
              child: RTCVideoView(_remoteRTCRenderer,
                ...
                return Container(
                  ...
                  child: Center(
                    child: Text(
                        "Vui lòng đợi ${((_iCallViewModel.callInfo.isCaller as bool) ? _iCallViewModel.callInfo.receiverName.toString() : _iCallViewModel.callInfo.callerName.toString())} tham gia"),
                  ),
                );
              }),
            ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Text(
                    ((_iCallViewModel.callInfo.isCaller as bool)
                        ? _iCallViewModel.callInfo.receiverName.toString()
                        : _iCallViewModel.callInfo.callerName.toString()),
  ...
  _leaveCall() {
    if (_iCallViewModel.callInfo.isCaller as bool) {
      _socket!.emit("leave-call", {"to": _iCallViewModel.callInfo.receiverId});
    } else {
      _socket!.emit("leave-call", {"to": _iCallViewModel.callInfo.callerId});
    }
    // Navigator.pop(context);
    // Navigator.of(context).pop();
    // Get.offNamed(MyRouter.booking);
    // AppGet.Get.back();
    AppGet.Get.offNamed(MyRouter.chatRoom);
  }
