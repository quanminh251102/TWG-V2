              ...
              return FadeTransition(
                ...
                child: Transform(
                  transform: Matrix4.translationValues(
                      100 * (1.0 - widget.animation!.value) <= 1.0
                          ? 1.1
                                  ...
                                  if (bookingSave != null) {
                                    setState(() {
                                      widget.booking.isFavorite =
                                          bookingSave.isFavorite;
                                    });
                                  }
                                },
                                child: widget.booking.isFavorite != null &&
                                        widget.booking.isFavorite!
                                    ? const Icon(
                                        Icons.bookmark,
                                        color: Colors.amber,
                                  ...
                                  SizedBox(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          widget.booking.startPointAddress ??
                                              "",
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            fontSize: 12.sp,
