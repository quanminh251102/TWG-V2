...
class _RestClient implements RestClient {
  ...
  @override
  Future<BaseApiDto<GoogleTokenDto>> getTokenGoogle(LoginDto model) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(model.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseApiDto<GoogleTokenDto>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BaseApiDto<GoogleTokenDto>.fromJson(
      _result.data!,
      (json) => GoogleTokenDto.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
